...
| 层 | 模块 | 职责 |
|---|---|---|
| L0 确定性内核 | `backends/pdfium.py`, `models.py`, `source_evidence.py`, `figures.py`, `content_render.py`, `region_render.py`, `writer.py` | PDFium inventory/materialization、provider 证据快照、Figure/Table/Equation 图片化、Markdown/manifest 写出 |
...
- 坐标与契约可回放：PhysicalDocument v0.2、Source Evidence v0.1、Article Model v0.1、Reader v0.1
