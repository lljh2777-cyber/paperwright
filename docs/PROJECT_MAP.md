...
|---|---|---|
| CLI and orchestration | `src/paperwright/cli.py`, `api.py`, `batch.py` | `test_cli.py`, `test_paths_api.py`, `test_phase5_alpha.py` |
...
| Routing | `routing.py`, `auto_layout.py`, `tools/run_routing_plan.py` | `test_routing.py`, `test_routing_plan.py` |
