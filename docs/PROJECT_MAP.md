...
| Paper-level decisions and structural compilation | `paper_recipe.py`, `schemas/paper_recipe.schema.json`, `schemas/article_tree.schema.json` | `test_paper_recipe.py`, `test_layout_stage_d.py` |
