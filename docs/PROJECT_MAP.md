...
| Source evidence and provider alignment | `source_evidence.py`, `pdfplumber_provider.py`, `schemas/source_evidence.schema.json` | `test_source_evidence.py`, `test_layout_stage_d.py` |
