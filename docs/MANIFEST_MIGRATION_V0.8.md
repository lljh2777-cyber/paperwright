...
PaperWright `0.8.0a0` 的混合布局写出从 manifest v0.7 升级到 v0.8。直接转换仍按
...
```html
<!-- pwwd:block id="blk_0123456789abcdef01234567" kind="body" -->
<!-- pwwd:slot id="slot_0123456789abcdef01234567" asset="ast_0123456789abcdef01234567" -->
```

锚点格式版本为 `paperwright-markdown-anchor-v0.1`。消费端不得从数组下标、Markdown
...
1. 读取 `_paperwright/manifest.json`，按版本选择路径。
