...
def compile_reviewed_article(
    ...
    *,
    ...
    title_marker = f'<!-- p2md:block id="{title_id}" kind="title" -->'
    ...
    blocks: list[dict[str, Any]] = [
        {
            ...
            "kind": "title",
            "order": 1,
            "anchor": {"syntax": "p2md:block", "id": title_id},
    ...
    for line in lines[start_index:]:
        ...
        if image_match is not None:
            ...
            marker = (
                f'<!-- p2md:slot id="{block_id}" asset="{asset_id}" -->'
            )
            anchor = {"syntax": "p2md:slot", "id": block_id}
            ...
            marker = (
                f'<!-- p2md:block id="{block_id}" kind="{kind}" -->'
            )
            anchor = {"syntax": "p2md:block", "id": block_id}
