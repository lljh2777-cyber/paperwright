...
AUTO_REGION_MANIFEST_VERSION = "paperwright-manifest-v0.5"
LEGACY_HYBRID_LAYOUT_MANIFEST_VERSION = "paperwright-manifest-v0.6"
PREVIOUS_HYBRID_LAYOUT_MANIFEST_VERSION = "paperwright-manifest-v0.7"
...
def validate_manifest(value: dict[str, Any]) -> None:
    ...
    if value["manifest_version"] == MANIFEST_VERSION:
        ...
        if value["manifest_version"] in {
            ...
            if (
                reader["contract_version"] != "paperwright-reader-v0.1"
                or reader["anchor_contract"]
                != "paperwright-markdown-anchor-v0.1"
            ):
                raise ContractValidationError("manifest reader 契约非法")
            if (
                reader["path"] != "_paperwright/reader.json"
        ...
        if value["manifest_version"] in {
            ...
            if (
                ...
                != "paperwright-article-model-v0.1"
                or article_model["path"] != "_paperwright/article-model.json"
        ...
        if value["manifest_version"] in {
            ...
            if (
                ...
                not in ("paperwright-text-task-v0.1", "paperwright-text-task-v0.2")
                or text_review["review_contract_version"]
                not in ("paperwright-text-review-v0.1", "paperwright-text-review-v0.2")
