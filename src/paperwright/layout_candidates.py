...
CANDIDATE_GENERATOR_VERSION = "paperwright-whitespace-candidates-v0.4"
FEATURE_SCHEMA_VERSION = "paperwright-layout-features-v0.2"
RASTER_CANDIDATE_GENERATOR_VERSION = (
    "paperwright-whitespace-raster-candidates-v0.3"
)
RASTER_FEATURE_SCHEMA_VERSION = "paperwright-layout-features-v0.3"
