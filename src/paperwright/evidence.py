...
def build_run_record(
    *,
    ...
    return {
        "contract_version": "paperwright-run-v0.1",
        "run_id": run_id,
        "completed_at_utc": datetime.now(timezone.utc).isoformat(
            timespec="seconds"
        ),
        "paperwright_version": package_version(),
...
def build_source_record(
    *,
    ...
    return {
        "contract_version": "paperwright-source-v0.1",
...
def build_validation_report(
    *,
    ...
    report = {
        "contract_version": "paperwright-validation-report-v0.2",
        "status": status,
