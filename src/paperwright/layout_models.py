...
LAYOUT_TASK_VERSION = "paperwright-layout-task-v0.1"
RASTER_LAYOUT_TASK_VERSION = "paperwright-layout-task-v0.2"
LAYOUT_TASK_VERSIONS = frozenset(
    {LAYOUT_TASK_VERSION, RASTER_LAYOUT_TASK_VERSION}
)
FINAL_LAYOUT_VERSION = "paperwright-final-layout-v0.1"
