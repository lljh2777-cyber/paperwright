...
Use this decision guide before constructing a PaperWright command. Ask only about
...
2. **Output destination**
   ...
   - PaperWright refuses to overwrite existing output. If the destination exists,
