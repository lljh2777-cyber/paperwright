---
name: paperwright-contribute
description: Understand, modify, test, review, and contribute to the PaperWright source repository. Use for bug fixes, features, refactors, documentation, schemas and manifest changes, layout heuristics, deterministic PDF reconstruction, test failures, release validation, code review, or preparing commits and pull requests for PaperWright.
---

# Contribute to PaperWright

Make scoped, evidence-backed changes while preserving PaperWright's deterministic and provenance-aware boundaries.
